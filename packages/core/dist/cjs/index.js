...
const NodeContext = React__default['default'].createContext(null);
...
function useInternalEditor(collector) {
  ...
  var connectorsUsage = React.useMemo(
    function () {
  ...
  var connectors = React.useMemo(
    function () {
      return (
        connectorsUsage && utils.wrapConnectorHooks(connectorsUsage.connectors)
      );
    },
    [connectorsUsage]
  );
...
function useInternalNode(collect) {
  ...
  invariant__default['default'](
    context,
    utils.ERROR_USE_NODE_OUTSIDE_OF_EDITOR_CONTEXT
  );
  var id = context.id,
...
const DefaultRender = () => {
  ...
  return React.useMemo(() => {
    ...
    if (typeof type == 'string') {
      return React__default['default'].createElement(SimpleElement, {
        render: render,
      });
    }
    return render;
...
const RenderNodeToElement = ({ render }) => {
  ...
  return React__default['default'].createElement(onRender, {
    render:
      render || React__default['default'].createElement(DefaultRender, null),
  });
};
...
function Element$1({ id, children, ...elementProps }) {
  ...
  const [linkedNodeId, setLinkedNodeId] = React.useState(null);
  utils.useEffectOnce(() => {
    ...
    if (inNodeContext) {
      ...
      if (existingNode && existingNode.data.type === is) {
        ...
        const linkedElement = React__default['default'].createElement(
          Element$1,
          elementProps,
          children
        );
  ...
  return linkedNodeId
    ? React__default['default'].createElement(NodeElement, { id: linkedNodeId })
    : null;
}

const deprecateCanvasComponent = () =>
  utils.deprecationWarning('<Canvas />', {
    suggest: '<Element canvas={true} />',
  });
function Canvas({ ...props }) {
  React.useEffect(() => deprecateCanvasComponent(), []);
  return React__default['default'].createElement(Element$1, {
    ...props,
    canvas: true,
  });
}
...
const RenderRootNode = () => {
  const { timestamp } = useInternalEditor((state) => ({
    timestamp:
      state.nodes[utils.ROOT_NODE] &&
      state.nodes[utils.ROOT_NODE]._hydrationTimestamp,
  }));
  if (!timestamp) {
    return null;
  }
...
const Frame = ({ children, json, data }) => {
  ...
  React.useEffect(() => {
    ...
    if (initialData) {
      ...
      const rootNode = React__default['default'].Children.only(initialChildren);
  ...
  return React__default['default'].createElement(RenderRootNode, null);
};
...
var Methods = function Methods(state, query) {
  ...
  var addNodeTreeToParent = function addNodeTreeToParent(
    ...
    if (!parentId) {
      invariant__default['default'](
        tree.rootNodeId === utils.ROOT_NODE,
...
var resolveComponent = function resolveComponent(resolver, comp) {
  ...
  invariant__default['default'](
    resolvedName,
    utils.ERROR_NOT_IN_RESOLVER.replace('%node_type%', componentName)
  );
  return resolvedName;
};
...
function createNode(newNode, normalize) {
  ...
  var id = newNode.id || utils.getRandomId();
  var node = {
    id: id,
...
function parseNodeFromJSX(jsx, normalize) {
  ...
  if (typeof element === 'string') {
    element = React__default['default'].createElement(
      React.Fragment,
      {},
      element
    );
  ...
  _createClass(Positioner, [
    ...
    },
    {
      ...
      value: function onScroll(e) {
        ...
        var rootNode = this.store.query.node(utils.ROOT_NODE).get();
    ...
    },
    {
      ...
      value: function computeIndicator(dropTargetId, x, y) {
        ...
        if (
          ...
          this.isNearBorders(utils.getDOMInfo(newParentNode.dom), x, y) &&
            ...
            var unbindDragEnd = _this2.addCraftEventListener(
              ...
              function (e) {
                ...
                _this2.dropElement(function (dragTarget, indicator) {
                  ...
                  if (options && lodash.isFunction(options.onCreate)) {
...
_defineProperty(
  ...
  utils.isChromium() && utils.isLinux()
);
...
const RenderEditorIndicator = () => {
  ...
  return React__default['default'].createElement(utils.RenderIndicator, {
    style: {
      ...movePlaceholder(
        indicator.placement,
        utils.getDOMInfo(indicator.placement.parent.dom),
        indicator.placement.currentNode &&
          utils.getDOMInfo(indicator.placement.currentNode.dom),
...
const Editor = ({ children, ...options }) => {
  ...
  return context
    ? React__default['default'].createElement(
        ...
        { value: context },
        React__default['default'].createElement(Events, null, children)
      )
    : null;
};
...
var getTestNode = function getTestNode(parentNode) {
  ...
  var validParentNode = createNode(cloneDeep__default['default'](parentNode));
